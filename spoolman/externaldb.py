...
class ExternalFilament(BaseModel):
    ...
    extruder_min_temp: int | None = Field(default=None, description="Extruder/nozzle min temperature in °C.", examples=[190])
    extruder_max_temp: int | None = Field(default=None, description="Extruder/nozzle max temperature in °C.", examples=[250])
    bed_min_temp: int | None = Field(default=None, description="Bed min temperature in °C.", examples=[45])
    bed_max_temp: int | None = Field(default=None, description="Bed max temperature in °C.", examples=[55])
