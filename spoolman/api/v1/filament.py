...
async def create(  # noqa: ANN201
    ...
    db_item = await filament.create(
        ...
        settings_extruder_min_temp=body.settings_extruder_min_temp,
        settings_extruder_max_temp=body.settings_extruder_max_temp,
        settings_bed_min_temp=body.settings_bed_min_temp,
        settings_bed_max_temp=body.settings_bed_max_temp,
