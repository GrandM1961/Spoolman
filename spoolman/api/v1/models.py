...
class Filament(BaseModel):
    ...
    settings_extruder_min_temp: int | None = Field(
        None,
        ge=0,
        description="Overridden extruder min temperature, in °C.",
        examples=[210],
    )
    settings_extruder_max_temp: int | None = Field(
        None,
        ge=0,
        description="Overridden extruder max temperature, in °C.",
        examples=[210],
    )
    settings_bed_min_temp: int | None = Field(
        None,
        ge=0,
        description="Overridden bed min temperature, in °C.",
        examples=[60],
    )
    settings_bed_max_temp: int | None = Field(
        None,
        ge=0,
        description="Overridden bed max temperature, in °C.",
        examples=[60],
    )
    ...
    def from_db(item: models.Filament) -> "Filament":
        ...
        return Filament(
            ...
            comment=item.comment,
            settings_extruder_min_temp=item.settings_extruder_min_temp,
            settings_extruder_max_temp=item.settings_extruder_max_temp,
            settings_bed_min_temp=item.settings_bed_min_temp,
            settings_bed_max_temp=item.settings_bed_max_temp,
