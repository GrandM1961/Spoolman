...
async def create(
    *,
    ...
    settings_extruder_min_temp: int | None = None,
    settings_extruder_max_temp: int | None = None,
    settings_bed_min_temp: int | None = None,
    settings_bed_max_temp: int | None = None,
    ...
    filament = models.Filament(
        ...
        comment=comment,
        settings_extruder_min_temp=settings_extruder_min_temp,
        settings_extruder_max_temp=settings_extruder_max_temp,
        settings_bed_min_temp=settings_bed_min_temp,
        settings_bed_max_temp=settings_bed_max_temp,
        color_hex=color_hex,
