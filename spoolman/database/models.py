...
class Filament(Base):
    ...
    comment: Mapped[str | None] = mapped_column(String(1024))
    settings_extruder_min_temp: Mapped[int | None] = mapped_column(comment="Overridden extruder min temperature.")
    settings_extruder_max_temp: Mapped[int | None] = mapped_column(comment="Overridden extruder max temperature.")
    settings_bed_min_temp: Mapped[int | None] = mapped_column(comment="Overridden bed min temperature.")
    settings_bed_max_temp: Mapped[int | None] = mapped_column(comment="Overridden bed max temperature.")
