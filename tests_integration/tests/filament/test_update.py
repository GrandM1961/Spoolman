...
def test_update_filament(random_vendor: dict[str, Any]):
    ...
    result = httpx.post(
        ...
        json={
            ...
            "comment": "abcdefghåäö",
            "settings_extruder_min_temp": 190,
            "settings_extruder_max_temp": 220,
            "settings_bed_min_temp": 60,
            "settings_bed_max_temp": 60,
            "color_hex": "FF0000",
    ...
    result = httpx.patch(
        ...
        json={
            ...
            "comment": new_comment,
            "settings_extruder_min_temp": new_settings_extruder_min_temp,
            "settings_extruder_max_temp": new_settings_extruder_max_temp,
            "settings_bed_min_temp": new_settings_bed_min_temp,
            "settings_bed_max_temp": new_settings_bed_max_temp,
...
def test_update_filament_cant_set_none(random_vendor: dict[str, Any]):
    ...
    result = httpx.post(
        ...
        json={
            ...
            "article_number": "123456789",
            "comment": "abcdefghåäö",
            "settings_extruder_tmin_emp": 190,
            "settings_extruder_max_temp": 220,
            "settings_bed_min_temp": 45,
            "settings_bed_max_temp": 60,
            "color_hex": "FF0000",
            "external_id": "external_id1",
        },
