...
const allColumns: (keyof IFilamentCollapsed & string)[] = [
  ...
  "spool_weight",
  "article_number",
  "settings_extruder_min_temp",
  "settings_extruder_max_temp",
  "settings_bed_min_temp",
  "settings_bed_max_temp",
  "registered",
  "comment",
];
