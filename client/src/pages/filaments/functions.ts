...
export async function createFilamentFromExternal(externalFilament: ExternalFilament): Promise<IFilament> {
  ...
  const body: Omit<IFilament, "id" | "registered" | "extra"> & { vendor_id: number } = {
    ...
    settings_extruder_min_temp: externalFilament.extruder_min_temp || undefined,
    settings_extruder_max_temp: externalFilament.extruder_max_temp || undefined,
    settings_bed_min_temp: externalFilament.bed_min_temp || undefined,
    settings_bed_max_temp: externalFilament.bed_max_temp || undefined,
