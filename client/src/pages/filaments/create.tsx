...
export const FilamentCreate = (props: IResourceComponentsProps & CreateOrCloneProps) => {
  ...
  const importFilament = async (filament: ExternalFilament) => {
    ...
    form.setFieldsValue({
      ...
      settings_extruder_min_temp: filament.extruder_min_temp || undefined,
      settings_extruder_max_temp: filament.extruder_max_temp || undefined,
      settings_bed_min_temp: filament.bed_min_temp || undefined,
      settings_bed_max_temp: filament.bed_max_temp || undefined,
    });
  };
  ...
  return (
    ...
    >
      ...
      <Form {...formProps} layout="vertical">
        ...
        <Form.Item
          label={t("filament.fields.settings_extruder_min_temp")}
          name={["settings_extruder_min_temp"]}
          rules={[
            {
              required: false,
              type: "number",
        ...
        <Form.Item
          label={t("filament.fields.settings_extruder_max_temp")}
          name={["settings_extruder_max_temp"]}
          rules={[
            {
              required: false,
              type: "number",
        ...
        <Form.Item
          label={t("filament.fields.settings_bed_min_temp")}
          name={["settings_bed_min_temp"]}
          rules={[
            {
              required: false,
              type: "number",
        ...
        <Form.Item
          label={t("filament.fields.settings_bed_max_temp")}
          name={["settings_bed_max_temp"]}
          rules={[
            {
              required: false,
              type: "number",
