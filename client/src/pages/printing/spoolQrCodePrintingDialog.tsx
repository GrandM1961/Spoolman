...
{ET: {filament.settings_extruder_min_temp} °C}
{ET: {filament.settings_extruder_max_temp} °C}
{BT: {filament.settings_bed_min_temp} °C}
{BT: {filament.settings_bed_max_temp} °C}
{Lot Nr: {lot_nr}}
{{comment}}
{filament.comment}
{filament.vendor.comment}`;
  ...
  const filamentTags = [
    ...
    { tag: "filament.settings_extruder_min_temp" },
    { tag: "filament.settings_extruder_max_temp" },
    { tag: "filament.settings_bed_min_temp" },
    { tag: "filament.settings_bed_max_temp" },
